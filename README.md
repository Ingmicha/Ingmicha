...
### Android Developer | Senior Mobile Development Analyst

Android engineer focused on building reliable mobile products with **Kotlin/Java**, modern Android architecture, and a strong quality mindset.

---

## About me
I build native Android solutions with a practical engineering approach: clean architecture foundations, maintainable code, and production awareness.

My current professional focus is on:
- Kotlin and Java Android development
- Jetpack Compose and Jetpack libraries
- SDK integration and SDK-oriented mobile solutions
- Mobile app security and reverse-engineering awareness
- Wallet and payment/tokenization ecosystems
- QA mindset, troubleshooting, and production support

---

## Tech stack
- **Languages:** Kotlin, Java
- **Android:** Jetpack Compose, Jetpack (Architecture Components), Android SDK
- **Architecture:** MVVM, Clean Architecture foundations, modular thinking
- **Quality & Delivery:** Fastlane, testing-oriented workflows, CI-friendly practices
- **Backend/API integration:** Retrofit, Firebase, REST APIs

---

## Specialty areas
- Native Android engineering (Kotlin/Java)
